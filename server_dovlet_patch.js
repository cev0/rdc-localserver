...
function dovletQaydalariniTetbiqEt() {
  ...
  if (deyisdi) {
    ...
    console.log("[DOVLET_PATCH] Aylıq Dövlət və enemy scout qaydaları tətbiq edildi.");
  }
}
