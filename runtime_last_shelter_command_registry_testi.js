...
lastShelterInitCommandiniQeydEt(router,{
...
assert.strictEqual(
  new Set(router.routes.keys()).size,
  router.routes.size
);

console.log(
  "PASS: all Last Shelter runtime command modules register together without route collisions."
);
