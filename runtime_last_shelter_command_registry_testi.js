...
const expected=[
  ...
  "troop.reference.list","troop.reference.get","resource.info","item.tuning.list","item.tuning.get","starter_account.info","goods.structure.list","goods.structure.get","store.reward.get","store.reward.catalog","alliance.group_purchase.info","alliance.group_purchase.offer","vipstore.panel",
  ...
  "troop.transfer.level6","troop.transfer.type","troop.transfer.point","hero.info","hero.get","hero.general.list","hero.general.get","alliance.group_purchase.info","alliance.group_purchase.offer.get","fort.troop.list","fort.troop.get","troop_transfer.reference.list","troop_transfer.reference.get","shop.reference.list","vip_store.info","repay.info","activity.reference.list","activity.reference.get","missile.info","seven_days.info","truck.info","world.info","battlefield.get","last_shelter.init"
];
